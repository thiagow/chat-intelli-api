...
export interface SearchScope {
  /** Organization ID — REQUIRED. Prevents cross-tenant data leakage. */
  organizationId: string;
  agentId?: string;
  contactId?: string;
  conversationId?: string;
  ...
  /** When searching for knowledge by agent: include this agent's knowledge AND org-wide knowledge. */
  agentScope?: {
    agentId: string;
